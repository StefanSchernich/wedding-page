...
//   return (
//     <>
//       <div className="mx-auto my-5 w-full max-w-sm rounded-md border border-gray-100 p-7">
//         {!isSubmitSuccessful && (
...
//                 autoComplete="false"
//                 className={`w-full rounded-md border-2 px-4  py-3 outline-none  focus:ring-4  ${
//                   errors.name
...
//                 className={`h-36 w-full rounded-md border-2  px-4 py-3  outline-none  focus:ring-4  ${
//                   errors.message
//                     ? "border-red-600 ring-red-100 focus:border-red-600"
//                     : "border-gray-300 ring-indigo-100 focus:border-indigo-600"
//                 }`}
...
//             <button
//               type="submit"
//               className="umami--click--contact-submit w-full rounded-md bg-indigo-600 px-7 py-4 text-white transition-colors hover:bg-indigo-500 focus:outline-none focus:ring focus:ring-indigo-200 focus:ring-offset-2"
//             >
//               {isSubmitting ? (
//                 <svg
